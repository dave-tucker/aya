use crate::{generated::bpf_attach_type, obj::ParseError};
use std::{
    convert::TryFrom,
    hash::Hash,
...
impl TryFrom<&str> for CgroupSockAddrAttachType {
    ...
    fn try_from(value: &str) -> Result<Self, Self::Error> {
        match value {
            ...
            _ => Err(ParseError::InvalidAttachType {
                attach_type: value.to_owned(),
                prog_type: "BPF_PROG_TYPE_CstructGROUP_SOCK_ADDR".to_owned(),
            }),
        }
    }
}
